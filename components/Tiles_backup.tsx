    ...
    <Animated.View style={[styles.container, { opacity: fadeAnim }]}>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>            <Text style={styles.modalTitle}>{tileLabels[selectedTile ?? 0]}</Text>
            ...
            {!showScratchCard ? (
              <>
                ...
                <TouchableOpacity 
                  ...
                  activeOpacity={0.7}
                >
                  <Text style={styles.closeText}>✨ Back ✨</Text>                </TouchableOpacity>
              </>
            ) : (
              <ScratchCard
...
const styles = StyleSheet.create({
  ...
  optionCard: {
    backgroundColor: 'linear-gradient(135deg, #ffeef8 0%, #fff 100%)',
    borderRadius: 24,
    padding: 20,
    alignItems: 'center',
    position: 'relative',
  ...
  clueIconContainer: {
    backgroundColor: 'linear-gradient(135deg, #ec4899, #d946ef)',
    shadowColor: '#ec4899',
  },
  dareIconContainer: {
  ...
  closeButton: {
    ...
    width: '100%',
    alignItems: 'center',
    backgroundColor: 'linear-gradient(135deg, #fdf2f8, #f3e8ff)',
    borderRadius: 24,
    borderWidth: 2,
    borderColor: '#e9d5ff',
    ...Platform.select({
